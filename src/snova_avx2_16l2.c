...
static int verify_signture_pkx_vtl(const uint8_t *pt_digest, uint64_t bytes_digest, const uint8_t *pt_signature,
...
int SNOVA_NAMESPACE(verify)(const expanded_PK *pk, const uint8_t *pt_signature, const uint8_t *pt_digest,
	...
	snova_init();
	return verify_signture_pkx_vtl(pt_digest, bytes_digest, pt_signature, (uint8_t *)pk);
}
