...
static uint8_t fixedAm[SNOVA_o * SNOVA_alpha * SNOVA_r2];
static uint8_t fixedBm[SNOVA_o * SNOVA_alpha * SNOVA_lr];
...
static void be_invertible_by_add_aS(gf_t* mat, const gf_t* orig, const int l1, const int l2);
