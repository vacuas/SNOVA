...
int SNOVA_NAMESPACE(sign)(const expanded_SK *skx, uint8_t *sig, const uint8_t *digest, const size_t len_digest,
	...
	do {
		 ...
		 */
		gf_t sum_t0[SNOVA_m * SNOVA_l * SNOVA_v * SNOVA_l2] = {0};
		gf_t sum_t1[SNOVA_m * SNOVA_l2 * SNOVA_v * SNOVA_l2] = {0};
		...
		// Whipped F21
		gf_t whipped_F21[SNOVA_m * SNOVA_l * SNOVA_o * SNOVA_l2] = {0};
#ifndef SYMMETRIC
		gf_t whipped_F12[SNOVA_m * SNOVA_l * SNOVA_o * SNOVA_l2] = {0};
#else
...
int SNOVA_NAMESPACE(verify)(const expanded_PK *pkx, const uint8_t *sig, const uint8_t *digest, const size_t len_digest) {
	...
	gf_t sum_t0[SNOVA_m * SNOVA_l * SNOVA_n * SNOVA_l2] = {0};
	gf_t sum_t1[SNOVA_m * SNOVA_l2 * SNOVA_n * SNOVA_l2] = {0};
